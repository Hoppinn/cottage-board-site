...
(function () {
  const ACH_DEFS = [
    // 플레이 기록 계열 (1→3→5→8→10→15→20→30→40→50→75→100→125→150→200→250→300→400→500)
    { id: 'rabbit_first',  name: '새싹 토끼 🌱',      emoji: '🌱', type: 'play', threshold: 1,
      rewards: { character: 'rabbit_first', voucher: true } },
    { id: 'play_3',        name: '첫 시작',            emoji: '🐾', type: 'play', threshold: 3,   rewards: {} },
    { id: 'play_5',        name: '코티지 단골곰',       emoji: '🐻', type: 'play', threshold: 5,
      rewards: { character: 'bear_10' } },
    { id: 'play_8',        name: '코티지의 밤',         emoji: '🌙', type: 'play', threshold: 8,
      rewards: { character: 'rare_night' } },
    ...
    { id: 'play_20',       name: '활발한 곰',            emoji: '🐻', type: 'play', threshold: 20,
      rewards: { character: 'bear_50' } },
    { id: 'bear_30',       name: '놀이 곰돌이 🐻',      emoji: '🐻', type: 'play', threshold: 30,
      rewards: { character: 'bear_30',      title: 'title_bear_30' } },
    ...
    { id: 'bear_100',      name: '코티지 곰 🏠',         emoji: '🏠', type: 'play', threshold: 150,
      rewards: { character: 'bear_100',     title: 'title_bear_100' } },
    ...
    { id: 'play_250',      name: '봄의 전령',            emoji: '🌸', type: 'play', threshold: 250,
      rewards: { character: 'season_spring' } },
    { id: 'bear_300',      name: '동면 곰 🌙',           emoji: '🌙', type: 'play', threshold: 300,
      rewards: { character: 'bear_300',     title: 'title_bear_300' } },
    { id: 'play_400',      name: '여름의 플레이어',      emoji: '☀️', type: 'play', threshold: 400,
      rewards: { character: 'season_summer' } },
    { id: 'cottage_master', name: '코티지 마스터 ✨',   emoji: '✨', type: 'play', threshold: 500,
      rewards: { character: 'cottage_master', title: 'title_cottage_master' } },
    // 새 게임 탐험 계열 (1→3→5→7→10→15→20→30→40→50→75→100→125→150→200→250→300)
    { id: 'new_game_1',    name: '첫 탐험',             emoji: '✨', type: 'new_game', threshold: 1,
      rewards: { character: 'rare_new_game' } },
    ...
    { id: 'owl_10',        name: '탐구 올빼미 🦉',      emoji: '🦉', type: 'new_game', threshold: 10,
      rewards: { character: 'owl_10' } },
    ...
    { id: 'owl_30',        name: '연구 올빼미 🦉',      emoji: '🦉', type: 'new_game', threshold: 30,
      rewards: { character: 'owl_30',     title: 'title_owl_30' } },
    ...
    { id: 'rabbit_200',    name: '방랑 토끼 🧳',        emoji: '🧳', type: 'new_game', threshold: 150,
      rewards: { character: 'rabbit_200', title: 'title_rabbit_200' } },
    { id: 'owl_200',       name: '박학 올빼미 📚',      emoji: '📚', type: 'new_game', threshold: 200,
      rewards: { character: 'owl_100',    title: 'title_owl_200' } },
    { id: 'new_game_250',  name: '핼러윈 수집가',        emoji: '🎃', type: 'new_game', threshold: 250,
      rewards: { character: 'season_halloween' } },
    { id: 'owl_300',       name: '전설 올빼미 🦉',      emoji: '🦉', type: 'new_game', threshold: 300,
      rewards: { character: 'owl_300',    title: 'title_owl_300' } },
    ...
    { id: 'photo_2',       name: '추억 시작',            emoji: '📸', type: 'photo', threshold: 2,  rewards: {} },
    { id: 'photo_3',       name: '추억 수집가',          emoji: '✨', type: 'photo', threshold: 3,
      rewards: { character: 'rare_first_record' } },
    ...
    { id: 'fox_5',         name: '감상 여우 🦊',        emoji: '🦊', type: 'review', threshold: 5,
      rewards: { character: 'fox_10' } },
    { id: 'review_8',      name: '번개 리뷰어',          emoji: '⚡', type: 'review', threshold: 8,
      rewards: { character: 'rare_lightning' } },
    ...
    { id: 'review_15',     name: '이야기꾼',             emoji: '✨', type: 'review', threshold: 15,
      rewards: { character: 'rare_storyteller' } },
    { id: 'review_20',     name: '코티지 논객',          emoji: '🗣️', type: 'review', threshold: 20, rewards: {} },
    { id: 'fox_25',        name: '취향 여우 🦊',        emoji: '🦊', type: 'review', threshold: 25,
      rewards: { character: 'fox_30',      title: 'title_fox_25' } },
    ...
    { id: 'hamster_200',   name: '마스터 햄스터 🏆',    emoji: '🏆', type: 'review', threshold: 150,
      rewards: { character: 'hamster_300', title: 'title_hamster_200' } },
    { id: 'review_200',    name: '박식한 여우',          emoji: '🦊', type: 'review', threshold: 200,
      rewards: { character: 'fox_100' } },
    { id: 'fox_300',       name: '코티지 여우 🦊',      emoji: '🦊', type: 'review', threshold: 300,
      rewards: { character: 'fox_300',     title: 'title_fox_300' } },
    // 방문 계열 (3→5→10→15→20→25→30→40→50→75→100→150→200→300→400→500)
    { id: 'visit_3',   name: '코티지 방문객',  emoji: '✨', type: 'visit', threshold: 3,
      rewards: { character: 'rare_friend' } },
    { id: 'visit_5',   name: '코티지 친구',    emoji: '🤗', type: 'visit', threshold: 5,  rewards: {} },
    { id: 'visit_10',  name: '코티지 단골 ☕', emoji: '☕', type: 'visit', threshold: 10,
      rewards: { character: 'sparrow_10',  title: 'title_visit_10' } },
    { id: 'visit_15',  name: '코티지 팬',      emoji: '💙', type: 'visit', threshold: 15, rewards: {} },
    { id: 'visit_20',  name: '코티지 단골Lv2', emoji: '☕', type: 'visit', threshold: 20, rewards: {} },
    ...
    { id: 'visit_50',  name: '코티지 주민 🔥', emoji: '🔥', type: 'visit', threshold: 50,
      rewards: { character: 'sparrow_50',  title: 'title_visit_50' } },
    ...
    { id: 'visit_200', name: '코티지 참새 🐦', emoji: '🐦', type: 'visit', threshold: 200,
      rewards: { character: 'sparrow_200', title: 'title_visit_200' } },
  ...
  async function buildCharacterSection(userId) {
    ...
    if (_lastEarnedChar) _charPreviewParts.push(`✓ ${_lastEarnedChar.emoji} ${_lastEarnedChar.name}`);
    if (_nextChar) {
      const _nc = COUNTS[_nextChar.type] || 0;
      _charPreviewParts.push(`→ ${_nextChar.emoji} ${_nextChar.name} (${SHORT_TYPE_LABELS[_nextChar.type] || _nextChar.type} ${_nc}/${_nextChar.threshold})`);
    }
