...
(function () {
  const ACH_DEFS = [
    ...
    { id: 'record_300', name: '삼백 번의 기록',       emoji: '🌙', type: 'record', threshold: 300,
      rewards: { title: 'title_bear_300' } },
    { id: 'record_400', name: '여름의 플레이어',      emoji: '☀️', type: 'record', threshold: 400,  rewards: {} },
    ...
    { id: 'new_game_250',  name: '핼러윈 수집가',         emoji: '🎃', type: 'new_game', threshold: 250,
      rewards: { character: 'season_halloween', char_name: '핼러윈 여우' } },
    ...
    { id: 'visit_400', name: '코티지의 산타',   emoji: '🎄', type: 'visit', threshold: 400,
      rewards: { character: 'season_christmas', char_name: '산타 다람쥐' } },
    ...
    { id: 'play_100', name: '백전노장',         emoji: '🏆', type: 'play', threshold: 100,
      rewards: { character: 'rare_night', char_name: '밤의 올빼미' } },
    ...
    { id: 'play_200', name: '게임왕',           emoji: '👑', type: 'play', threshold: 200,
      rewards: { character: 'bear_lv5', char_name: '동면 곰' } },
    { id: 'play_300', name: '코티지 신화',     emoji: '🌙', type: 'play', threshold: 300,
      rewards: { character: 'season_summer', char_name: '여름 토끼' } },
