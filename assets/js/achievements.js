...
(function () {
  ...
  const ACH_DEFS = [
    ...
    { id: 'record_150', name: '백오십 번의 기록',    emoji: '🏠', type: 'record', threshold: 150,
      rewards: { character: 'squirrel_lv4', char_name: '겨울준비 다람쥐', title: 'title_record_150' } },
    ...
    { id: 'review_100', name: '백 번의 감상',       emoji: '🎓', type: 'review', threshold: 100,
      rewards: { character: 'hamster_lv3', char_name: '평론가 햄스터', voucher: true, title: 'title_review_100' } },
    ...
    { id: 'review_500', name: '전설의 리뷰어',      emoji: '✨', type: 'review', threshold: 500,
      rewards: { character: 'hamster_lv5', char_name: '전설의 평론가 햄스터', title: 'title_review_500' } },
    // ── visit (참새)
