...
* 난이도 기본 제한을 2.5 이하로 수정
* 헤비·매니아 / 하드코어 선택 시 제한 해제
* 필터 변경 시 게임카드 스크롤이 맨 앞으로 이동하도록 수정

### 헤더 검색 시스템

* 헤더 우측에 🔍 검색 버튼 추가
* 검색 버튼 클릭 시 검색창 드롭다운 열림
* 검색 결과 클릭 시 상세 바텀시트 연결
* 검색창 바깥 클릭 시 자동 닫힘
* 검색 중 햄버거 메뉴 자동 닫힘
* 검색어 유지 구조 적용
* 검색창 다시 열면 이전 검색 결과 재표시

### 검색 시스템 개선

* 일반 검색 + 초성 검색 혼합 구조 적용
* ㄱ / ㄱㅇ / 글 / 글ㄹ 같은 검색 지원
* 초성 startsWith 우선 정렬 적용
* 한글 초성 조합 예외 처리
...
* store-usage-guide.html 생성
* contact.html 생성
* 모든 페이지 헤더 공통화
* 검색 헤더를 owned-games 포함 다른 페이지에도 적용
...
* 전체게임 상세페이지 UI 연결
* 새 게임명만 입력하면 자동 업데이트되는 tools/CMD 구조
* 서버 직접 입력/모바일 관리 구조 검토
