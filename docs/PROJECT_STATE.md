...
| # | 항목 | 위치 | 등급·모델 |
|---|------|------|----------|
| 0 | 🚀 **배포(push)만 남음** — #19·#22·#24·R3 전부 코드·검증 완료. 마이그레이션 012는 운영 DB 적용됨. 배포 후 총이용시간이 **줄어드는 게 정상**(3배 부풀어 있던 게 1배로) | §0 | 배포 |
...
| 2 | 🎯 **P3b — 드릴다운** (이벤트·페이지 → **그걸 한 사람들**로). 원칙 ⑤의 최대 결손이자 "유기적"의 핵심. **선행이던 「시간」 정리는 2026-07-20 종결** — 이제 소스가 하나라 내려가도 숫자가 안 갈린다 | [admin-analytics.md](admin-analytics.md) §5 | Plan / Opus |
