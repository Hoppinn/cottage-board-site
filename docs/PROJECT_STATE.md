...
- ~~**[4] 게임시트 수정/삭제 버튼 상단 탈출 버그**~~ — CSS 수정 (142차-106). .sheet-comment-actions의 position:absolute 규칙을 .sheet-comment-item .sheet-comment-actions로 스코프 축소. .sheet-play-scroll-card에 position:relative 없어서 패널 top-right으로 탈출한 것이 원인. 원인 커밋: 8d60f5c(2026-06-25).
