...
최종 갱신: 2026-07-22 (세션 ㉗ — GS5 escH 사본 통합). **무엇이 닫혔는지는 git log와 도메인 문서에 있다** — 이 문서는 **지금 열려 있는 것**만 갖는다.
...
| 2 | **남은 실착수 후보 없음** — §5(기획·디자인)에서 고르거나 「열린 스모크」를 실기기로 닫으면 된다 | §5 | — | GS5는 2026-07-22 종결(git log) |
