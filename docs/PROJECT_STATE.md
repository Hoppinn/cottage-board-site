...
- ~~**[4] 모임별 바텀시트 ··· 메뉴 겹침 버그**~~ — CSS로 구조적 수정 (142차-104). body.sheet-open 시 .pr-rec-more-menu { display:none !important }. 게임시트 열릴 때 body에 sheet-open 클래스 추가됨을 이용. z-index 의존 없이 완전 차단.
