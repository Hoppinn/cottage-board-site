...
| # | 항목 | 위치 | 등급 | 왜 이 순서 |
|---|------|------|------|---|
| **1** | **관리자 분석 P6(집계 정확도) — Red+Plan.** 4개 하위(①0초·③기기중복·④자정넘김·⑥로그인잔여). ③은 iframe(#24)으로 종결 → 남은 ①④⑥ 각각 재측정 후 Plan. 사용자 판단으로 P4보다 우선(2026-07-22) | [admin-analytics.md](admin-analytics.md) §4·§5 | 구조 | 관리자가 보는 숫자 교정이 새 기능보다 값이 큼 |
