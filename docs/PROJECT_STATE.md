...
| # | 항목 | 위치 | 등급·모델 |
|---|------|------|----------|
| 1 | 🎯 **관리자 분석 P1 — 도달률** (이벤트 탭에 "기간 방문 249명 중 70명 28% · 회원 88%/비회원 24%"). 분모 건전성 실측 완료(교집합 100%) | [admin-analytics.md](admin-analytics.md) §5 | 옐로 / Sonnet high |
| 2 | 🎯 **P2 — 기준 표기 정리** (#9 요약 카드 기간·말줄임 / #11 "7일" 버튼이 실제 이번 주 / #8 축 라벨). 전부 원칙 ①(무엇을·언제·누구를 셌는지) 위반 | 〃 | 그린·옐로 / Sonnet |
