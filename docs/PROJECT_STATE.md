...
- [ ] **시각 완성도 개선** — 레이아웃·기능·색상 체계 변경 없이 모바일 기준 완성도 10~20% 향상
  ...
  - **히어로 배너**: 갈색 유지하되 은은한 그라데이션으로 입체감 추가. 럭셔리 느낌 아닌 따뜻한 카페 느낌.
  - **버튼 일관성**: 전체 페이지 버튼 높이·radius·padding·글자크기 통일 (추천게임/동호회/요청하기/프로필 비교)
