...
**다음 작업 후보 (우선)**
- **[143차-155 미완료 — [4]+[5]]** 게임시트 링크 재배치: `게임위치 ← 꽂혀있는 책장 보기 / 룰영상 보기 / 게임 정리법 보기` 레이아웃으로 script.js HTML 템플릿 수정 (Yellow)
- **[143차-155 미완료 — [8]]** stats(베스트N명/약N분/난이도) 크기 키워 한 줄 꽉 차게 (Green CSS)
- **[143차-155 미완료 — [6] item 5]** 기록페이지 스크롤 상태에서 썸네일 클릭 시 상단 초기화 버그 (JS)
