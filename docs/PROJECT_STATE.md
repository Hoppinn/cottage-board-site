...
- [~] **6단계: 등록 모달 다주치** — ①②②-a②-b②-c 완료, ③ 진행 중
  - [x] ①②②-a②-b: 주 네비·Step2·날짜칩·진입 통합
  - [x] ②-c: 홈 등록 직행 (c289793 + 31e6568→30f96b9→63b41d0→e2cd0c2→3676131→b93aaeb 안정화)
  - [ ] ③: Step3 게임 선택 분리 + "건너뛰고 저장" + 다중 날짜 경로 Step3 필수 + 본인 기등록 날짜 차단
- [ ] **[Red] 마이그레이션 009 묶음**: 2.7 대표 게임(is_priority) + 7단계 인원 조건 컬럼 + 모임 참가 unique 제약(기존 중복 row 정리 선행)
