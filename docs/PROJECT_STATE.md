...
최종 갱신: 2026-07-27 (세션 ㊵ — **캡션 복사 역할 분리 완료**(git `49b6909b`, 실DB Playwright 검증). 다음 시작점은 §0 표 1번(간식·음료 요청 Part2, Plan 필요). **무엇이 닫혔는지는 git log와 도메인 문서에 있다** — 이 문서는 **지금 열려 있는 것**만 갖는다.
