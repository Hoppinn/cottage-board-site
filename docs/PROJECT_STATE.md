...
- **스모크 확인 필요**: ①본인 보드 참여일 1일뿐일 때 (요일) 배지 사라짐 ②취향 외 게임 추가 시 ✨ 뜸/취향 게임엔 마크 없음 ③막대 밑 요약칩 사라짐 ④모임보드 라벨 글자만 ⑤남의 보드 자세히 = 전원 막대 차트(편집 버튼 없음) ⑥4곳 게임 썸네일 노출·크기 확인 ⑦'그날의 게임'이 하고싶은/배우고싶은 그룹으로 나뉘고 개별 칩에 🎲/📖 없음 ⑧막대 밑 태그도 동일 그룹화·전체일정보기 버튼 사라짐 ⑨이날 모임 상세(구 한눈에보기)에서 '그날의 게임' 사라지고 참여자별 보기 기본 펼침 ⑩진입 버튼 문구 '이날 모임 상세', 참여자별 게임 옆에 인원조건(무관/베스트N인) 표시.
