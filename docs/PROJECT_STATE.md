...
- ~~**[4] 모임별 바텀시트 게임평수정 겹침 버그**~~ — 구조적 수정 완료 (142차-103). pr-rec-more-menu z-index를 9999→9400으로 낮춰 게임시트(9500)가 열릴 때 자동으로 덮히도록. (이전 시도: _closeAllMoreMenus 타이밍 의존 방식은 실패)
