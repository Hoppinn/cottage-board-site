...
**다음 세션 시작점**: R1~R6 누적분 실서버 스모크 확인(안 되면 콘솔 에러 공유) 후 **R7(GDA2 — game-display-adapter.js IIFE 적용 + GS3, Opus xhigh, Plan 필수)** — 외부 참조 전수 확인 선행. 이후 R8~R13은 REFACTOR_CHECKPOINT.md "처리 계획" 표 순서대로.
