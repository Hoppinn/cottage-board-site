...
최종 갱신: 2026-06-12 (43차 — 썸네일 클릭 수정 + 플레이 감상 코멘트 연동)
...
- **`docs/DESIGN_AUDIT.md`** (진행 중 — 작업 재개 전 필독)
  - 2026-06 디자인 감사 / 일회성 임시 문서. 4차까지 진행.
  - 대부분 완료. 잔여: 방문자 수 RLS 확인, 푸터 정보 묶음(낮음), club.html/club-history.html 타이포+여백
  - **방문자 수 trackPageView**: RLS 의심. Supabase page_views 테이블 최신 행 직접 확인 필요. console.warn 추가됨(커밋 f5609dd) → 다음 방문 시 브라우저 콘솔에서 에러 메시지 확인
