...
| # | 항목 | 위치 | 등급 | 왜 이 순서 |
|---|------|------|------|---|
| **1** | **탭 구조 압축안 적용 여부 — 결정만 하면 닫힌다.** 추천: **적용 안 함**(원칙 ④를 이미 지키는 화면, 합치면 P3b 드릴다운까지 재작업) | [admin-analytics.md](admin-analytics.md) §5 | 결정 | ①확인·결정으로 닫히는 것이 맨 앞(B-5) |
| 2 | **관리자 분석 P4·P6 — Red+Plan, 실행 전 승인 필요**(P4 남의 보드 관리자 섹션·오너 가드 / P6 집계 정확도 재설계) | [admin-analytics.md](admin-analytics.md) §5 | 구조 | 되돌리기 어려움 |
