...
| 항목 | 묶음 | 내용 |
|------|------|------|
| E-2 기록보드 플레이기록 썸네일 → 게임기록시트 | 기록보드 썸네일 | 플레이기록 렌더에 썸네일 클릭 핸들러 추가. 위치 탐색 선행 |
| E-3 기록보드 사진 라이트박스 좌하단 게임 썸네일 | 기록보드 썸네일 | 큰사진 라이트박스 좌하단 빈공간에 해당 게임 썸네일 + 클릭 시 게임기록시트. 라이트박스 레이아웃 손봄 |
