...
- ~~**[플레이기록 기록입력 탭 안내 문구]**~~ — 완료 (143차-182). 기록입력 탭의 게임 검색 위에 `🎁 첫 플레이 기록 작성 시 음료 교환권 1장 지급` 안내 한 줄 추가. 기록보기 탭 변경 없음.
...
- ~~**[Hero CTA 개선 — 확정 사항]**~~ — 완료 (143차-182). Primary 버튼은 기존 베이지/크림 Filled 유지, Secondary "기록 남기기"는 아웃라인 유지 + 브라운 테두리/굵기 강화. CSS 값 변경만.
