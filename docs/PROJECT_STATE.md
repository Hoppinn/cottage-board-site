...
- [x] 취향 보드 Phase 1 (142차) — 한줄소개(bio), 좋아하는/해보고싶은 게임(추가/삭제/직접입력), 피하는 유형 태그. SQL: profiles.bio/avoid_tags, game_likes/game_curious.custom_name 컬럼 추가 필요
