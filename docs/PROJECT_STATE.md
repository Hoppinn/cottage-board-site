...
- ~~**[4] 모임별 바텀시트 ··· 메뉴 겹침 버그**~~ — JS로 구조적 수정 (142차-105). _closeAllMoreMenus()에서 모든 .pr-rec-more-menu에 style.display='none' 직접 설정. ··· 재오픈 시 style.display='' 초기화. 원인: 8d60f5c에서 position:fixed 도입으로 발생.
