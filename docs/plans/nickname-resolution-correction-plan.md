...
> **상태: 완료된 구현 Plan / 역사 보존용.** 현재 identity·public nickname·historical participant resolver의 정본은 [js-api.md](../js-api.md)다. 이 문서는 당시 변경 범위와 검증 설계를 설명하며, 새 구현의 활성 계획이 아니다.
