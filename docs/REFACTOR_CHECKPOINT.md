...
**이관**: 감사 항목 중 처리되지 않은 잔여분(PU5·GDA3·ACH2·SC6 등)은 [PROJECT_STATE §3 「Phase 1~3 감사 잔여 항목」](PROJECT_STATE.md)으로 옮겼다(2026-07-17 실측 결과 포함). ⚠️ **감사 항목을 다시 찾을 땐 그 목록을 볼 것 — 이 문서엔 더 이상 없다.**
